 ...
 * Kompilacja:          $ gcc tls_dh_anon_client.c -lssl -o tls_dh_anon_client
 * Uruchamianie:        $ ./tls_dh_anon_client <adres IP> <numer portu>
 */
...
int main(int argc, char** argv) {
     ...
     * Mozna podac zestaw explicite, np.: ADH-AES256-SHA
     */
